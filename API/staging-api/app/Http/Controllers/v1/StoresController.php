...
class StoresController extends Controller
{
    ...
    public function getList(Request $request){
        $data = DB::table('stores')->select('stores.*','users.first_name as user_first_name',
                    'cities.name as city_name','users.last_name as user_last_name','users.cover as user_cover','commission.rate as commission_rate')
