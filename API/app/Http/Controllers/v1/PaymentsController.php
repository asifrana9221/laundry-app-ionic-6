...
class PaymentsController extends Controller
{
    ...
    public function instaMOJOWebSuccess(Request $request){
        ...
        //
        $data = ProductOrders::find($request->id)->update(['status'=>0,'paid'=>json_encode($request->all())]);
        if (is_null($data)) {
    ...
    public function dpo_create_token(Request $request){
        // return $request;
        ...
        $xmlData = "<?xml version=\"1.0\" encoding=\"utf-8\"?><API3G><CompanyToken>$CompanyToken</CompanyToken><Request>$Request</Request><Transaction><PaymentAmount>$PaymentAmount</PaymentAmount><PaymentCurrency>$PaymentCurrency</PaymentCurrency><CompanyRef>49FKEOA</CompanyRef><RedirectURL>$RedirectURL</RedirectURL><BackURL>$BackURL </BackURL><CompanyRefUnique>0</CompanyRefUnique><PTL>5</PTL></Transaction><Services><Service><ServiceType>$ServiceType</ServiceType><ServiceDescription>$ServiceDescription</ServiceDescription><ServiceDate>$ServiceDate</ServiceDate></Service></Services></API3G>";
